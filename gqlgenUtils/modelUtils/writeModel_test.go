...
func TestWriteModelFiles(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			req: args{
				...
				files:          []string{"index.js", "model.js", "list.js", "query.js", "mutation.js"},
	...
	for _, tt := range cases {
		...
		t.Run(tt.name, func(t *testing.T) {
			err := modelUtils.WriteModelFiles(
				tt.req.modelName,
				tt.req.dirName,
				tt.req.fields,
				tt.req.fieldTypes,
